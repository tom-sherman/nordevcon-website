    ...
    <ol className="lg:absolute top-0 right-0">
      {
        Object.keys(Theme).map(track => (
          <li className="align-middle">
            <span className="mr-2 inline-block w-4 h-4 align-middle" style={{ backgroundColor: Theme[track] }}></span>
            { track }
          </li>
        ))
      }
                ...
                <>
                  ...
                  <li key={start} className="flex py-2">
                    ...
                    <div className="flex-grow">
                      <Talks talks={schedule[start]} speakers={speakers} tracks={Tracks} theme={Theme} />
                    </div>
                  </li>
                </>
              ))
